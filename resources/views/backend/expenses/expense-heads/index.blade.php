...
@section('script')
    <script>
        $(document).ready(function(){
            const options = {};
            options.url = '{{ route("expense-heads.list") }}';
            options.type = 'GET';
            options.columns = 
                    [
                        { data: null, orderable: false, searchable: false },
                        { data: 'title', name: 'expense_heads.cat_name'},
                        // { data: 'code', name: 'expense_heads.cat_name'},
                        { data: 'cat_name', name: 'expense_categories.cat_name'},
                        { 
                            data: null, 
                            name: 'expense_heads.status', 
                            orderable: true, 
                            searchable: false, 
                        ...
                        { 
                            ...
                            searchable: false, 
                            render: function(data, type, row, meta) {
                                let edit = `{{ route('expense-heads.edit', ":id") }}`.replace(':id', row.id);
