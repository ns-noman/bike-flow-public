                      ...
                      <div class="invoice p-3 mb-3" id="my-invoice">
                          ...
                          <div class="row invoice-info">
                              ...
                              <div class="col-sm-4 invoice-col">
                                  To
                                  <address>
                                      <strong>{{ $data['master']['buyer_name'] }}</strong><br>
                                      Phone: {{ $data['master']['buyer_contact'] }}<br>
                                      NID: {{ $data['master']['buyer_nid'] }} <br>
                                      DL No: {{ $data['master']['buyer_dl_no'] }} <br>
                                      Passport No: {{ $data['master']['buyer_passport_no'] }} <br>
                                      ...
                                      <thead>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ $data['basicInfo']['currency_symbol'] }} {{ number_format($data['master']['sale_price'], 2) }}</td>
                                            </tr>
                                        </tbody>
                                  </table>
                              </div>
